...
#pragma mark - 视图显示控制
// 显示引导页
NSString *const kNC_GuideVC_ShowNotification = @"NC_GuideVC_ShowNotification";
// 销毁引导页
NSString *const kNC_GuideVC_RemoveNotification = @"NC_GuideVC_RemoveNotification";

// 显示登录页
NSString *const kNC_LoginVC_ShowNotification = @"NC_LoginVC_ShowNotification";
// 销毁登录页
