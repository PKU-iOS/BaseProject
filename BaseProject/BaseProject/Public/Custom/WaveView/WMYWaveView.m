...
#define kWaveColor  [UIColor whiteColor]
...
- (BOOL)wave {
    ...
    self.waveShapeLayer.fillColor = RGBA(123, 250, 214, 0.18).CGColor;
    [self.layer addSublayer:self.waveShapeLayer];
    
    self.waveShapeLayer2 = [CAShapeLayer layer];
    self.waveShapeLayer2.fillColor = RGBA(123, 250, 214, 0.26).CGColor;
